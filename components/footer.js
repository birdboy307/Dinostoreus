...
export default function Navbar() {
  return (
    <div className="h-16 w-full drop-shadow-lg sticky top-0 bg-white">
        <div className="flex flex-row">
            ...
            <div className="basis-1/4 translate-y-1/2 flex justify-center">
                <a href="" className="mx-1 ease-in-out duration-150 hover:rotate-6 hover:scale-110">
                ...
                <a href="https://github.com/birdboy307/Dinostoreus" className="mx-1 ease-in-out duration-150 hover:rotate-6 hover:scale-110">
