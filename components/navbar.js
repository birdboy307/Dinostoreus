...
export default function Navbar() {
  return (
    <div className="h-16 w-full drop-shadow-lg sticky top-0">
        <div className="flex flex-row">
            ...
            <div className="basis-1/4 translate-y-1/2 flex justify-center">
                <a>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 antialiased ease-in-out duration-150 hover:rotate-6 hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
